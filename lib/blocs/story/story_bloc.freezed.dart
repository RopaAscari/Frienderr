...
mixin _$StoryState {
  ...
  List<Story> get quicks => throw _privateConstructorUsedError;
...
abstract class $StoryStateCopyWith<$Res> {
  ...
  $Res call({String error, List<Story> quicks, StoryStatus status});
}
...
abstract class _StoryState implements StoryState {
  factory _StoryState({String error, List<Story> quicks, StoryStatus status}) =
      _$_StoryState;

  @override
  String get error;
  @override
  List<Story> get quicks;
  @override
