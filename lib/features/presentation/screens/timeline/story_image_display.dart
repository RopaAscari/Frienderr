...
class StoryImageDisplay extends StatefulWidget {
  const StoryImageDisplay({Key? key, required this.story, required this.user})
      : super(key: key);
  final Story story;
  final UserModel user;
  @override
  State<StoryImageDisplay> createState() => _StoryImageDisplayState();
}

class _StoryImageDisplayState extends State<StoryImageDisplay> {
