...
import 'package:frienderr/features/presentation/widgets/gallery_picker/path_wrapper.dart';

class MultiAssetPickerBuilder extends DefaultAssetPickerBuilderDelegate {
  MultiAssetPickerBuilder({
          ...
          child: Container(
            ...
            child: Selector<DefaultAssetPickerProvider,
              ...
              selector: (_, DefaultAssetPickerProvider p) {
                PathWrapper<AssetPathEntity> wrapper = PathWrapper(
                    path: p.currentPath ?? AssetPathEntity(id: "", name: ""));
                return wrapper;
              },
