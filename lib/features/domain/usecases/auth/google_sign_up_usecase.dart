...
@lazySingleton
class GoogleSignUpUseCase extends UseCase<AuthResponse, GoogleSignUpParams> {
  GoogleSignUpUseCase(this.repository);

  final IAuthRepository repository;

  @override
  Future<Either<Failure, AuthResponse>> call(GoogleSignUpParams params) {
    return repository.googleProviderSignUp();
  }
}
