...
import '../../features/data/repositories/comment_repository_impl.dart' as _i84;
...
import '../../features/data/repositories/following_repository_impl.dart'
    as _i22;
import '../../features/data/repositories/notification_repository.dart' as _i46;
import '../../features/data/repositories/post_repository_impl.dart' as _i48;
import '../../features/data/repositories/quick_repository_impl.dart' as _i50;
import '../../features/data/repositories/story_repository_impl.dart' as _i52;
...
import '../../features/domain/repositiories/comment_repository.dart' as _i83;
...
import '../../features/domain/repositiories/notification_repository.dart'
    as _i45;
import '../../features/domain/repositiories/post_repository.dart' as _i47;
import '../../features/domain/repositiories/quick_repository.dart' as _i49;
import '../../features/domain/repositiories/story_repository.dart' as _i51;
...
import '../../features/domain/usecases/notification/send_like_notification_usecase.dart'
    as _i57;
import '../../features/domain/usecases/post/create_post_usecase.dart' as _i65;
import '../../features/domain/usecases/post/delete_post_usecase.dart' as _i68;
import '../../features/domain/usecases/post/get_user_posts_usecase.dart'
    as _i81;
import '../../features/domain/usecases/post/like_post_usecase.dart' as _i53;
import '../../features/domain/usecases/post/unlike_post_usecase.dart' as _i58;
import '../../features/domain/usecases/quick/create_quick.dart' as _i66;
import '../../features/domain/usecases/quick/delete_quick.dart' as _i69;
import '../../features/domain/usecases/quick/get_quicks.dart' as _i78;
import '../../features/domain/usecases/quick/get_user_snaps.dart' as _i82;
import '../../features/domain/usecases/quick/like_quick.dart' as _i54;
import '../../features/domain/usecases/quick/unlike_quick.dart' as _i59;
import '../../features/domain/usecases/story/create_story_usecase.dart' as _i67;
import '../../features/domain/usecases/story/delete_story_usecase.dart' as _i70;
import '../../features/domain/usecases/story/get_story_stream_usecase.dart'
    as _i79;
import '../../features/domain/usecases/story/get_story_usecase.dart' as _i80;
import '../../features/domain/usecases/story/update_story_usecase.dart' as _i60;
import '../../features/domain/usecases/story/view_story_usecase.dart' as _i62;
...
import '../../features/domain/usecases/timeline/get_post_stream_usecase.dart'
    as _i76;
import '../../features/domain/usecases/timeline/get_posts_usecase.dart' as _i77;
...
import '../../features/presentation/blocs/chat/chat_bloc.dart' as _i64;
import '../../features/presentation/blocs/comment/comment_bloc.dart' as _i94;
...
import '../../features/presentation/blocs/notification/notification_bloc.dart'
    as _i85;
import '../../features/presentation/blocs/post/post_bloc.dart' as _i86;
import '../../features/presentation/blocs/quick/quick_bloc.dart' as _i89;
import '../../features/presentation/blocs/story/story_bloc.dart' as _i90;
import '../../features/presentation/blocs/theme/theme_bloc.dart' as _i33;
import '../../features/presentation/blocs/timeline/timeline_bloc.dart' as _i91;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i38.GetAccountFollowersUseCase>(
      () => _i38.GetAccountFollowersUseCase(get<_i18.IFollowersRepository>()));
  gh.lazySingleton<_i39.GetChatsUsecase>(
      () => _i39.GetChatsUsecase(get<_i14.IChatRepository>()));
  gh.lazySingleton<_i40.GetFollowersUseCase>(
      () => _i40.GetFollowersUseCase(get<_i21.IFollowingRepository>()));
  gh.lazySingleton<_i41.GetFollowingUseCase>(
      () => _i41.GetFollowingUseCase(get<_i21.IFollowingRepository>()));
  gh.lazySingleton<_i42.GetPlatformUsersUseCase>(
      () => _i42.GetPlatformUsersUseCase(get<_i28.IUserRepository>()));
  gh.lazySingleton<_i43.GetUserIdUseCase>(
      () => _i43.GetUserIdUseCase(get<_i11.IAuthRepository>()));
  gh.lazySingleton<_i44.GetUserUseCase>(
      () => _i44.GetUserUseCase(get<_i28.IUserRepository>()));
  gh.lazySingleton<_i45.INotificationRepository>(() =>
      _i46.NotificationRepository(get<_i23.INotificationRemoteDataProvider>(),
          get<_i27.IUserDataRemoteProvider>()));
  gh.lazySingleton<_i47.IPostRepository>(() => _i48.PostRepository(
      get<_i24.IPostRemoteDataProvider>(),
      get<_i27.IUserDataRemoteProvider>(),
      get<_i45.INotificationRepository>()));
  gh.lazySingleton<_i49.IQuickRepository>(() => _i50.QuickRepository(
      get<_i25.IQuickRemoteDataProvider>(),
      get<_i27.IUserDataRemoteProvider>()));
  gh.lazySingleton<_i51.IStoryRepository>(() => _i52.StoryRepository(
      get<_i26.IStoryDataRemoteProvider>(),
      get<_i27.IUserDataRemoteProvider>()));
  gh.lazySingleton<_i53.LikePostUseCase>(
      () => _i53.LikePostUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i54.LikeQuickUseCase>(
      () => _i54.LikeQuickUseCase(get<_i49.IQuickRepository>()));
  gh.lazySingleton<_i55.SendCommentNotificationUseCase>(() =>
      _i55.SendCommentNotificationUseCase(get<_i45.INotificationRepository>()));
  gh.lazySingleton<_i56.SendFollowNotificationUseCase>(() =>
      _i56.SendFollowNotificationUseCase(get<_i45.INotificationRepository>()));
  gh.lazySingleton<_i57.SendLikeNotificationUseCase>(() =>
      _i57.SendLikeNotificationUseCase(get<_i45.INotificationRepository>()));
  gh.lazySingleton<_i58.UnLikePostUseCase>(
      () => _i58.UnLikePostUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i59.UnLikeQuickUseCase>(
      () => _i59.UnLikeQuickUseCase(get<_i49.IQuickRepository>()));
  gh.lazySingleton<_i60.UpdateStoryUseCase>(
      () => _i60.UpdateStoryUseCase(get<_i51.IStoryRepository>()));
  gh.factory<_i61.UserBloc>(
      () => _i61.UserBloc(get<_i42.GetPlatformUsersUseCase>()));
  gh.lazySingleton<_i62.ViewStoryUseCase>(
      () => _i62.ViewStoryUseCase(get<_i51.IStoryRepository>()));
  gh.factory<_i63.AuthenticationBloc>(() => _i63.AuthenticationBloc(
  ...
  gh.factory<_i64.ChatBloc>(() => _i64.ChatBloc(get<_i39.GetChatsUsecase>()));
  gh.lazySingleton<_i65.CreatePostUseCase>(
      () => _i65.CreatePostUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i66.CreateQuickUseCase>(
      () => _i66.CreateQuickUseCase(get<_i49.IQuickRepository>()));
  gh.lazySingleton<_i67.CreateStoryUseCase>(
      () => _i67.CreateStoryUseCase(get<_i51.IStoryRepository>()));
  gh.lazySingleton<_i68.DeletePostUseCase>(
      () => _i68.DeletePostUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i69.DeleteQuickUseCase>(
      () => _i69.DeleteQuickUseCase(get<_i49.IQuickRepository>()));
  gh.lazySingleton<_i70.DeleteStoryUseCase>(
      () => _i70.DeleteStoryUseCase(get<_i51.IStoryRepository>()));
  gh.factory<_i71.FollowersBloc>(
      () => _i71.FollowersBloc(get<_i40.GetFollowersUseCase>()));
  gh.factory<_i72.FollowingBloc>(
      () => _i72.FollowingBloc(get<_i41.GetFollowingUseCase>()));
  gh.lazySingleton<_i73.GetNotificationStreamUseCase>(() =>
      _i73.GetNotificationStreamUseCase(get<_i45.INotificationRepository>()));
  gh.lazySingleton<_i74.GetNotificationUseCase>(
      () => _i74.GetNotificationUseCase(get<_i45.INotificationRepository>()));
  gh.lazySingleton<_i75.GetPaginatedPostsUseCase>(
      () => _i75.GetPaginatedPostsUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i76.GetPostsStreamUseCase>(
      () => _i76.GetPostsStreamUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i77.GetPostsUseCase>(
      () => _i77.GetPostsUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i78.GetQuickUseCase>(
      () => _i78.GetQuickUseCase(get<_i49.IQuickRepository>()));
  gh.lazySingleton<_i79.GetStoryStreamUseCase>(
      () => _i79.GetStoryStreamUseCase(get<_i51.IStoryRepository>()));
  gh.lazySingleton<_i80.GetStoryUseCase>(
      () => _i80.GetStoryUseCase(get<_i51.IStoryRepository>()));
  gh.lazySingleton<_i81.GetUserPostsUseCase>(
      () => _i81.GetUserPostsUseCase(get<_i47.IPostRepository>()));
  gh.lazySingleton<_i82.GetUserSnapsUseCase>(
      () => _i82.GetUserSnapsUseCase(get<_i49.IQuickRepository>()));
  gh.lazySingleton<_i83.ICommentRepository>(() => _i84.CommentRepository(
      get<_i16.ICommentRemoteDataProvider>(),
      get<_i27.IUserDataRemoteProvider>(),
      get<_i45.INotificationRepository>()));
  gh.factory<_i85.NotificationBloc>(() => _i85.NotificationBloc(
      get<_i74.GetNotificationUseCase>(),
      get<_i57.SendLikeNotificationUseCase>(),
      get<_i73.GetNotificationStreamUseCase>(),
      get<_i55.SendCommentNotificationUseCase>(),
      get<_i56.SendFollowNotificationUseCase>()));
  gh.factory<_i86.PostBloc>(() => _i86.PostBloc(
      get<_i77.GetPostsUseCase>(),
      get<_i53.LikePostUseCase>(),
      get<_i65.CreatePostUseCase>(),
      get<_i58.UnLikePostUseCase>(),
      get<_i68.DeletePostUseCase>(),
      get<_i76.GetPostsStreamUseCase>(),
      get<_i75.GetPaginatedPostsUseCase>()));
  gh.lazySingleton<_i87.PostCommentUseCase>(
      () => _i87.PostCommentUseCase(get<_i83.ICommentRepository>()));
  gh.factory<_i88.ProfileAccountBloc>(() => _i88.ProfileAccountBloc(
      get<_i81.GetUserPostsUseCase>(),
      get<_i38.GetAccountFollowersUseCase>(),
      get<_i41.GetFollowingUseCase>(),
      get<_i82.GetUserSnapsUseCase>(),
      get<_i44.GetUserUseCase>()));
  gh.factory<_i89.QuickBloc>(() => _i89.QuickBloc(
      get<_i78.GetQuickUseCase>(),
      get<_i66.CreateQuickUseCase>(),
      get<_i69.DeleteQuickUseCase>(),
      get<_i54.LikeQuickUseCase>(),
      get<_i59.UnLikeQuickUseCase>()));
  gh.factory<_i90.StoryBloc>(() => _i90.StoryBloc(
      get<_i80.GetStoryUseCase>(),
      get<_i60.UpdateStoryUseCase>(),
      get<_i67.CreateStoryUseCase>(),
      get<_i70.DeleteStoryUseCase>(),
      get<_i79.GetStoryStreamUseCase>(),
      get<_i62.ViewStoryUseCase>()));
  gh.factory<_i91.TimelineBloc>(() => _i91.TimelineBloc(
      get<_i77.GetPostsUseCase>(),
      get<_i76.GetPostsStreamUseCase>(),
      get<_i75.GetPaginatedPostsUseCase>()));
  gh.factory<_i92.UserAccountBloc>(() => _i92.UserAccountBloc(
      get<_i81.GetUserPostsUseCase>(),
      get<_i38.GetAccountFollowersUseCase>(),
      get<_i41.GetFollowingUseCase>(),
      get<_i82.GetUserSnapsUseCase>(),
      get<_i44.GetUserUseCase>()));
  gh.lazySingleton<_i93.GetCommentsUseCase>(
      () => _i93.GetCommentsUseCase(get<_i83.ICommentRepository>()));
  gh.factory<_i94.CommentBloc>(() => _i94.CommentBloc(
      get<_i93.GetCommentsUseCase>(), get<_i87.PostCommentUseCase>()));
  return get;
}
